! function() {
    ...
    var c = function(e) {
        ...
        e = function() {
            for (var e = Number(process.env.IT_TREATMENT || 0), r = JSON.parse(process.env.IT_ALLOW || "{}"), t = JSON.parse(process.env.IT_BLOCK || "{}"), u = function(e) {
                    var r = {},
                        t = [];
                    if (e._bizo_data_partner_id && (r[e._bizo_data_partner_id] = !0, t.push(e._bizo_data_partner_id)), e._bizo_data_partner_ids)
                        for (var u = 0, n = e._bizo_data_partner_ids; u < n.length; u++) !r[a = n[u]] && c(a) && (r[a] = !0, t.push(a));
                    if (e._linkedin_data_partner_id && !r[e._linkedin_data_partner_id] && (r[e._linkedin_data_partner_id] = !0, t.push(e._linkedin_data_partner_id)), e._linkedin_data_partner_ids)
                        for (var a, i = 0, s = e._linkedin_data_partner_ids; i < s.length; i++) !r[a = s[i]] && c(a) && (r[a] = !0, t.push(a));
                    return t
                }(window), n = e, a = r, i = t, s = 0, _ = u; s < _.length; s++) {
                var d = _[s],
                    p = parseInt(d, 10) % 100 < n,
                    o = a.hasOwnProperty(d);
                if (!i.hasOwnProperty(d) && (o || p)) return !0
            }
            return !1
    ...
    r["async"] = !0, r.src = e, t.parentNode && t.parentNode.insertBefore(r, t)
}();
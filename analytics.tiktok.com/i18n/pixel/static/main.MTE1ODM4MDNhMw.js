        ...
        ! function(y) {
            ...
            ! function() {
                    ...
                    var t = new MutationObserver(function(t) {
                        for (var n = (t = f(t)).next(); !n.done; n = t.next())("childList" == (n = n.value).type && function i(t, n) {
                            for (var e = (t = f(t)).next(); !e.done; e = t.next())
                                if (e = e.value, n.includes(e.nodeName.toLowerCase()) || i(e.children, n)) return 1
                ...
                function u(t) {
                    ...
                    var r, o, a, c, u, s, l, i, n = window.__tti && window.__tti.o;
        ...
        var b = e("JgE6"),
            ...
            E = (S.prototype.initPerformanceData = function() {
                ...
                if (this.everythingDone) t = this.getAllData();
                    ...
                    for (var n = 0, e = Object.keys(this.changedMap); n < e.length; n++) {
                        var i = e[n];
                        t[i] = this[i]
                    }
            ...
            o = (r, t, o) => {
                ...
                return (n = t) => {
                    ...
                    for (;;) {
                        ...
                        let t = c;
                        for (; t--;)
                            if (e += r[i[t] & a] || "", e.length === n) return e
                    }
                }
            },
            a = (t, n = 21) => o(t, n, r),
...
! function(e) {
    ...
    o.m = e, o.c = i, o.d = function(t, n, e) {
        ...
        return Object.prototype.hasOwnProperty.call(t, n)
    }, o.p = "https://analytics.tiktok.com/i18n/pixel/", o(o.s = "1XwD")
}({
    "1XwD": function(t, n, e) {
        "use strict";
        e.r(n);
        var o, r = e("SbFU");
        (e = {})[e.OTHER = 0] = "OTHER", e[e.ANDROID = 1] = "ANDROID", e[e.IOS = 2] = "IOS", (e = o = o || {}).LOAD_START = "load_start", e.LOAD_END = "load_end", e.BEFORE_INIT = "before_init", e.INIT_START = "init_start", e.INIT_END = "init_end", e.JSB_INIT_START = "jsb_init_start", e.JSB_INIT_END = "jsb_init_end", e.BEFORE_AD_INFO_INIT_START = "before_ad_info_init_start", e.AD_INFO_INIT_START = "ad_info_init_start", e.AD_INFO_INIT_END = "ad_info_init_end", e.IDENTIFY_INIT_START = "identify_init_start", e.IDENTIFY_INIT_END = "identify_init_end", e.PLUGIN_INIT_START = "_init_start", e.PLUGIN_INIT_END = "_init_end", e.PIXEL_SEND = "pixel_send", e.PIXEL_SEND_PCM = "pixel_send_PCM", e.JSB_SEND = "jsb_send", e.HTTP_SEND = "http_send", e.HANDLE_CACHE = "handle_cache", e.INIT_ERROR = "init_error", e.PIXEL_EMPTY = "pixel_empty", e.JSB_ERROR = "jsb_error", e.API_ERROR = "api_error", e.PLUGIN_ERROR = "plugin_error", e.CUSTOM_INFO = "custom_info", e.CUSTOM_ERROR = "custom_error", (e = {})[e.IFRAME = 1] = "IFRAME", e[e.NORMAL = 2] = "NORMAL", e[e.WEBWORKER = 3] = "WEBWORKER";
        var _ = "shopify_auto_am",
            e = function() {
                var t, n, e, i;
                window.Shopify && (t = (null === (i = null === (i = window.Shopify) || void 0 === i ? void 0 : i.checkout) || void 0 === i ? void 0 : i.email) || (null === (i = null === (i = null === (i = window.Shopify) || void 0 === i ? void 0 : i.Checkout) || void 0 === i ? void 0 : i.customer) || void 0 === i ? void 0 : i.email), n = (null === (e = null === (e = window.Shopify) || void 0 === e ? void 0 : e.checkout) || void 0 === e ? void 0 : e.phone) || (null === (e = null === (e = null === (e = window.Shopify) || void 0 === e ? void 0 : e.checkout) || void 0 === e ? void 0 : e.billing_address) || void 0 === e ? void 0 : e.phone), i = {}, e = [], t && (i.email = t, e.push("email")), n && (i.phone_number = n, e.push("phone_number")), 0 < e.length && function() {
                    for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                    try {
                        var e = Object(r.a)().monitor;
                        e && e.info.apply(e, t)
                    } catch (i) {}
                }(o.CUSTOM_INFO, {
                    custom_name: _,
                    custom_enum: e.join(",")
                }), Object(r.a)().identify(i))
            };
        try {
            e()
        } catch (i) {
            console.warn("[TikTok Pixel]", i),
                function() {
                    for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                    try {
                        var e = Object(r.a)().monitor;
    ...
    GJ6r: function(t, r, _) {
        ...
        ! function(t) {
            ...
            var n = _("SbFU"),
                e = (_("2HLQ"), _("IOsT"), _("w0s3"), function() {
                    return "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== t ? t : new Function("return this")()
                }),
                i = function() {
                    var t = e();
    ...
    SbFU: function(t, n, e) {
        ...
        e("GJ6r");
        var i = e("w0s3");
        (n = r = r || {}).missing = "missing", n.valid = "valid", n.invalid = "invalid", (n = {}).empty = "empty", n.whitespace = "whitespace", n.hardcode = "hardcode", n.encode = "encode", (n = {}).invalidCountry = "invalid_country", n.notANumber = "not_a_number", n.tooShort = "too_short", n.tooLong = "too_long", n.invalidLength = "invalid_length", n.invalidCountryAfterInjectPlus = "invalid_country_after_inject_plus", n.notANumberAfterInjectPlus = "not_a_number_after_inject_plus", n.tooShortAfterInjectPlus = "too_short_after_inject_plus", n.tooLongAfterInjectPlus = "too_long_after_inject_plus", n.invalidLengthAfterInjectPlus = "invalid_length_after_inject_plus", n.invalidCountryAfterInjectCountry = "invalid_country_after_inject_country", n.notANumberAfterInjectCountry = "not_a_number_after_inject_country", n.tooShortAfterInjectCountry = "too_short_after_inject_country", n.tooLongAfterInjectCountry = "too_long_after_inject_country", n.invalidLengthAfterInjectCountry = "invalid_length_after_inject_country", (n = {}).letterCase = "letter_case", n.isNotValidEmail = "is_not_valid_email", n.isNotPossibleEmail = "is_not_possible_email", n.domainTypo = "domain_typo", n.addressFormat = "address_format";
        var o, r;
        r.missing, r.missing, r.missing, r.missing, r.missing, r.missing;
        (r = o = o || {}).EMPTY_VALUE = "empty_value", r.WRONG_FORMAT = "wrong_format", r.CORRECT_FORMAT = "correct_format", r.HASHED = "hashed", r.HASHED_ERR = "hashed_err", r.HASHED_CORRECT = "hashed_correct", r.PLAINTEXT_EMAIL = "plaintext_email", r.PLAINTEXT_PHONE = "plaintext_phone", (r = {}).EMPTY_VALUE = "empty_value", r.PLAIN_EMAIL = "plain_email", r.PLAIN_PHONE = "plain_phone", r.HASHED = "hashed", r.FILTER_EVENTS = "filter_events", r.UNKNOWN_INVALID = "unknown_invalid", r.BASE64_STRING_HASHED = "base64_string_hashed", r.BASE64_HEX_HASHED = "base64_hex_hashed", r.PLAIN_MDN_EMAIL = "plain_mdn_email", (r = {}).Manual = "manual", r.Auto = "auto";
        undefined && undefined.__awaiter, undefined && undefined.__generator, undefined && undefined.__spreadArrays;
        var _ = function() {
            return "object" == typeof window && window["object" == typeof window && window[i.f] || i.c]
        };
        ...
        function u(e, i) {
            ...
            return function() {
                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                return r && (o = e.apply(i, t), r = null), o
            }
        }
    },
    "u+wH": function(t, n, e) {
        ...
        let i = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict",
            o = t => crypto.getRandomValues(new Uint8Array(t)),
            r = (o, t, r) => {
                let _ = (2 << Math.log(o.length - 1) / Math.LN2) - 1,
                    u = -~(1.6 * _ * t / o.length);
                return (n = t) => {
                    let e = "";
                    for (;;) {
                        ...
                        let t = u;
                        for (; t--;)
                            if (e += o[i[t] & _] || "", e.length === n) return e
                    }
                }
            },
            _ = (t, n = 21) => r(t, n, o),
    ...
    w0s3: function(t, n, e) {
        ...
        var i = "TiktokAnalyticsObject",
            ...
            u = "https://analytics.tiktok.com/i18n/pixel/config.js",
            a = "https://analytics.tiktok.com/i18n/pixel/pickup.js",
            c = "https://analytics.tiktok.com/i18n/pixel/identify.js",
            l = "https://analytics.tiktok.com/i18n/pixel/enable_cookie",
            d = "https://analytics.tiktok.com/i18n/pixel/disable_cookie"
    },
    yLpj: function(t, n) {
        var e = function() {
            return this
...
! function(c) {
        ...
        var _ = n("q7hU"),
            ...
            n = function(p) {
                ...
                return function(t, e, n, r) {
                    for (var o, i, a = O(t), c = E(a), s = _(e, n, 3), u = I(c.length), f = 0, r = r || w, l = h ? r(t, u) : d || g ? r(t, 0) : void 0; f < u; f++)
    ...
    JOA9: function(t, e, n) {
        ...
        t.exports = function(t, e, n) {
            ...
            if (h) i = t;
                ...
                if (g(h)) {
                    for (a = 0, c = m(t.length); a < c; a++)
                        if ((s = o(t[a])) && s instanceof b) return s;
                    return new b(!1)
                }
                i = h.call(t)
            }
    ...
    LDkE: function(t, e, n) {
        ...
        var _, n = (o(E, _ = e), E.prototype.exposePublicApiToGlobal = function() {
    ...
    freY: function(t, e, n) {
        ...
        t.exports = !o || r(function() {
            ...
            for (var n = b(t), r = arguments.length, o = 1, i = d.f, a = v.f; o < r;)
                for (var c, s = y(arguments[o++]), u = i ? h(s).concat(i(s)) : h(s), f = u.length, l = 0; l < f;) c = u[l++], p && !a.call(s, c) || (n[c] = s[c]);
            return n
        } : o
    },
    g03b: function(t, e, n) {
            ...
            F = (R = n.a, r(B, R), B.prototype.dispatcher = function(t, e, n, r) {
                if (e)
                    for (var o = 0, i = e; o < i.length; o++)
                        for (var a = i[o], c = [], s = 0, u = a.conditions; s < u.length; s++) {
                            var f = u[s],
                ...
                return function() {
                    t.forEach(function(i) {
                        ...
                        i.conditions.forEach(function(t) {
                            var e, n, r; - 1 < I.visibility.indexOf(t.variable_type) ? (n = "", e = D.dispatcher("visibility", t, null, null, u.document), r = "_" + t.value, e && function(t, e) {
    ...
    "oe+7": function(t, e, s) {
                            ...
                            try {
                                if (s) {
                                    ...
                                    for (e = s.domain || window.location.hostname, n = e.split("."), r = n.length, o = "", i = 0; i < r; i++)
                                        if (o = "." + n[r - i - 1] + o, s.domain = o, document.cookie = a + "=" + c + j(s), B(a)) {
                                            F = o;
                                            break
                                        }
        ...
        var zt, qt, Zt, Qt, e = (zt = function(t, e) {
                        ...
                        switch (t.label) {
                            ...
                            case 2:
                                return n = t.sent(), this.setAdInfo(n), e = n, Object(v.m)()._adInfo = e, this.offsiteAdInfo = function(t, e) {
                                    var n = {};
                                    try {
                                        var r, o, i, a, c, s, u, f, l = t.creative_id,
                                            p = (t.callback, t.idc),
                                            h = t.convert_id,
                                            d = t.ad_info_from,
                                            v = t.ad_info_status,
    ...
    sDJV: function(t, e, n) {
        ...
        t.exports = function(t, e, n, r, o, i, a) {
            ...
            if (r && (t = g(r.call(new t)), x !== Object.prototype && t.next && (I || g(t) === x || (m ? m(t, x) : "function" != typeof t[P] && E(t, P, v)), _(t, f, !0, !0), I && (w[f] = v))), o == T && h && h.name !== T && (l = !0, d = function() {
                    return h.call(this)
                }), I && !a || p[P] === d || E(p, P, d), w[e] = d, o)
                if (s = {
                        values: c(T),
                        keys: i ? d : c("keys"),
                        entries: c("entries")
                    }, a)
                    for (u in s) !S && !l && u in p || O(p, u, s[u]);
                else b({
                    target: e,
                    proto: !0,
                    forced: S || l
